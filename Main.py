...
def primos():
    ...
    ventanaPrimos.geometry('400x400')  # Ancho por alto
    ventanaPrimos.configure(background='turquoise')  # color de fondo de la ventana
...
def fibonacci():
    ...
    ventanaFibonacci.geometry('400x400')  # Ancho por alto
    ventanaFibonacci.configure(background='turquoise')  # color de fondo de la ventana
    # text: texto que dirá el label, bg:color del fondo del label, fg: color del texto
    # padx=e o pady=e, son para dejar espacio entre objetos, en donde la e es una constante.
...
def bases():
    ...
    ventanaBaseaBase.geometry('400x400')  # Ancho por alto
    ventanaBaseaBase.configure(background='turquoise')  # color de fondo de la ventana
    # text: texto que dirá el label, bg:color del fondo del label, fg: color del texto
    # padx=e o pady=e, son para dejar espacio entre objetos, en donde la e es una constante.
...
ventanaOpciones.configure(background='turquoise')  # color de fondo de la ventana
# text: texto que dirá el label, bg:color del fondo del label, fg: color del texto
# padx=e o pady=e, son para dejar espacio entre objetos, en donde la e es una constante.
lblOpciones = tk.Label(ventanaOpciones, text="¿QUE DESEA CALCULAR?", bg="turquoise", fg="black")
lblOpciones.pack(pady=30)
btnCalcular1 = tk.Button(ventanaOpciones, text="PRIMOS", bg="black", fg="white", command=primos)
btnCalcular1.pack(pady=15)
btnCalcular2 = tk.Button(ventanaOpciones, text="FIBONACCI", bg="black", fg="white", command=fibonacci)
